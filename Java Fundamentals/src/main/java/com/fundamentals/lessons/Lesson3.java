...
public class Lesson3 {
    ...
    /*charAt return a single character based
    ...
    /* comcat joins two string together as
     * communication. The same as the joinWelcome
     * method above.*/
...
public void differentCase() {
    ...
    /*Format allow you to use placeholder santax instead
    * of concatenation. Each %letter has a special meaning.*/
    ...
    /* Achar is a single character data type */
    ...
    * or other situations */
    public String escapeMe() {
        return "Today\'s class is going over string.\tIt"+
                " also\ncovered char.";
    }
    ...
    /* length will return the number of character
    ...
    /*String builder allow you tp join objects
