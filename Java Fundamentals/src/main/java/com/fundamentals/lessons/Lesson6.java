...
public class Lesson6 {
    ...
    public void demoDecrement() {
        ...
        /*Post Decrement - Value is decremented
         *  by 1 then computed */
        jerry = --tom;
    ...
    /* Method return the positive value
     * of an argument */
    public double imPositive(double num1) {
        return Math.abs(num1);
    }

    /* Return the smallet value greater
     * than equal to the argument */
    ...
    * than or equal to the argument */
    ...
    /* Round the value with positive up */
    ...
    public void addSomeNumbers() {
        int num1, num2, total;
        System.out.println("Enter two interger to" +
                " calculate their sum.");
